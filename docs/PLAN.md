...
- [x] Vérifié dans le navigateur au scénario `bloc-2` : le lundi qui suit la sortie longue porte un Z2 de 1 h 15 et plus une endurance de 75'. **La force basse cadence n'apparaît pas chez Ronan** : avec six jours disponibles (pas de jeudi) et le Legs du mardi, les deux seuls jours libres d'une semaine de base sont le lundi et le mercredi, tous deux à 24 h du Legs. La règle est juste, c'est la semaine qui ne peut pas la porter ; en ouvrant le jeudi, la force se pose le samedi. À trancher avec Ronan : laisser le vélo sans intensité en base, ou libérer un jour.
