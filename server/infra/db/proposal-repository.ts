...
import type { Prescription } from '../../domain/running/session-types'
...
import { athlete, pause, proposal, race, session, week } from './schema'
import { buildContext } from './rule-context'
