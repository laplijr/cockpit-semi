...
Projet personnel de Ronan : cockpit d'entraînement (course à pied, vélo, muscu), web desktop, gratuit, mono-utilisateur.
...
- Écran principal hiérarchisé (instruments → aujourd'hui + à décider → semaine, cap). Un nouvel élément y remplace ou rétrograde un existant, sinon il va dans une page ou un panneau. Desktop 1440 uniquement, pas de mobile, pas de PWA.
